...
/// <param name="properties">Optional authentication properties associated with the challenge.</param>
...
{
    /// <summary>
    /// When set to <c>true</c> by an event handler, indicates the challenge
    /// has been handled and no further processing should occur.
    /// </summary>
